...
# url = r"C:\Users\bruno\Downloads\books.json"    #CAMBIAR PARA QUE SE UBIQUE EN EL SERVER
...
def modificar_libro(eleccion: str, autor: str, pais : str, link_imagen: str, idioma: str, link: str,
    ...
    Tambien recibe los nuevos valores de TODOS los atributos del libro, para ser modificados.
    '''
